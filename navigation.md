...
[💾 Save & Share]()
  ...
  - <a href="javascript: void(window.open('http://compose.mail.yahoo.com/?body=' + encodeURIComponent('[' + document.title + '](' + window.location.href + ')：'  + document.getSelection()) ));">📧 用 <img src="ymail.png" /> Yahoo 寄信</a>
  ----
  - #↪ Share
  ...
  - <a href="javascript: void(window.open('https://twitter.com/intent/tweet?url=' + encodeURIComponent(window.location.href) + '&text=' + encodeURIComponent(document.title +'\n' + document.getSelection()) + '\n\n'));">分享到 <img src="twitter.png" /> Twitter</a>
  - <a href="javascript: void(window.open('https://plus.google.com/share?url=' + encodeURIComponent(window.location.href) + '&text=' + encodeURIComponent(document.title +'\n' + document.getSelection())));">分享到 <img src="gp.png" /> Google+</a>
...
[🔃  2016.12.24 更新]()
  ...
  - #更新項目
  - [🆕 更新 LINE 機器人的手機互動介面](#!update.md "2016.12.22")
  - [🆕 增加 SKYPE、新浪微博、Telegram 分享功能](#!update.md "2016.12.18")
...
<!-- 
  ...
  - [🆕 建立燈箱獨立 function](#!update.md#[2016.11.11]_建立燈箱獨立_function "2016.11.11")
  - [🆕 新增 其他輕量版固定字體，並在介面做收納。](#!update.md#[2016.11.10]_新增_其他輕量版固定字體，並在介面做收納。 "2016.11.10")
  - [🆕 新增 手動輕量版的「Kazesawa フォント」、「源暎ラテゴ」](#!update.md#[2016.11.09]_新增_手動輕量版的「Kazesawa_フォント」、「源暎ラテゴ」 "2016.11.09")
  - [🆕 新增 共鳴](#!update.md#[2016.11.08]_新增_共鳴 "2016.11.08")
  - [🆕 新增 站外工具/原價屋硬碟真比價書籤工具](#!update.md#[2016.11.01]_新增_站外工具_/_原價屋硬碟真比價書籤工具 "2016.11.01")
  - [🆕 新增 線上網頁字體：有華康(動態變化)、Google 思源](#!update.md#[2016.10.30]_新增_線上網頁字體：有華康(動態變化)、Google_思源 "2016.10.30")
  - [🆕 增加 字體變化測試 function](#!update.md#[2016.10.22]_增加_字體變化測試_function "2016.10.22 Icon font 暫時不考慮")
  - [🆕 增加 手機板 Chrome 變色處理、繁簡轉換修正、完成 Line](#!update.md#[2016.10.21]_增加_手機板_Chrome_變色處理、繁簡轉換修正、完成_Line_分享 "2016.10.21")
  - [增加 OneNote、Flipboard，修正噗浪、Gmail 手機BUG。](#!update.md#[2016.10.20]_增加_OneNote、Flipboard，修正噗浪、Gmail_手機BUG。 "2016.10.20")
  - [增加「語言/漢字轉換」：可不換頁轉換漢字外觀](#!update.md#[2016.10.19]_增加「語言/漢字轉換」：可不換頁轉換漢字外觀 "2016.10.19")
  - [\[內/外部都調整\]完成「Trello 格式化儲存卡片功能」並新增儲存分享按鈕](#!update.md#[2016.10.18]_[內/外部都調整]完成「Trello_格式化儲存卡片功能」並新增儲存分享按鈕 "2016.10.18")
